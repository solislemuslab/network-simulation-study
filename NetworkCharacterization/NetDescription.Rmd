...
```{r chunk1, cache = TRUE, fig.asp = 1.0, dev.args  = list(pointsize = 10),fig.cap = "\\label{fig:chunk1} Percentage of tree types using NetSim with parameters lambda = 0.9, mu = 0.5 and nu = 0.03,",echo=FALSE}
#Code to plot 
Summ<-summary(bdNS)[,1]
...
```{r chunk73, cache = TRUE, fig.asp = 1.0, dev.args  = list(pointsize = 10),fig.cap = "\\label{fig:chunk64} Corelation plot",echo=FALSE}
